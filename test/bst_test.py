...
class TestBST(unittest.TestCase):
    ...
    def test_initialize_bst(self):
        ...
        self.test_tree.root = self.test_tree.insert_node(self.test_player_86)
        self.assertEqual(test_name, self.test_tree.root.player_name)

    # test inserting an element less than the root.
    def test_insert_left(self):
        first_node = self.test_tree.insert_node(self.test_player_86)
        self.test_tree.root = self.test_tree.insert_node(self.test_player_101, first_node)
        left_node = self.test_tree.root.left
        self.assertEqual(self.test_player_101.player_name, left_node.player_name)

    def test_insert_right(self):
        first_node = self.test_tree.insert_node(self.test_player_86)
        self.test_tree.root = self.test_tree.insert_node(self.test_player_14, first_node)
    ...
    def test_search_pass(self):
        root = self.test_tree.insert_node(self.test_player_14)
        self.test_tree.insert_node(self.test_player_101, root)
        self.test_tree.insert_node(self.test_player_71, root)
        self.test_tree.insert_node(self.test_player_86, root)
        self.test_tree.insert_node(self.test_player_93, root)
        self.test_tree.insert_node(self.test_player_37, root)
